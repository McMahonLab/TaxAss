...
Trim the Marathonas full-length 16S sequences to the variable regions amplified by primers in tag data. Do this for several commonly used primer sets that amplify regions of differing lengths.  
...
Run TaxAss on each simulated tag dataset. create separate folders for each of them.
