...
# unzip your FreshTrain reference (using GG-compatible for example:)
cp ../../FreshTrain-files/FreshTrain25Jan2018NoBadLineage/FreshTrain25Jan2018NoBadLineage.fasta add-tax-scripts-and-databases/custom.fasta
cp ../../FreshTrain-files/FreshTrain25Jan2018NoBadLineage/FreshTrain25Jan2018NoBadLineage.taxonomy  add-tax-scripts-and-databases/custom.taxonomy
...
cd v4_mara
mkdir v4_results
Rscript ../compare_full-length_to_taxass_results.R ../mara.taxonomy otus.98.80.80.taxonomy ids.above.98 v4_results
cd ../
```
...
cd v4v5_mara
mkdir v4v5_results
Rscript ../compare_full-length_to_taxass_results.R ../mara.taxonomy otus.98.80.80.taxonomy ids.above.98 v4v5_results
cd ../
```
...
cd v3v4_mara
mkdir v3v4_results
Rscript ../compare_full-length_to_taxass_results.R ../mara.taxonomy otus.98.80.80.taxonomy ids.above.98 v3v4_results
cd ../
```
...
cd v6_mara
mkdir v6_results
Rscript ../compare_full-length_to_taxass_results.R ../mara.taxonomy otus.98.80.80.taxonomy ids.above.98 v6_results
cd ../
```
