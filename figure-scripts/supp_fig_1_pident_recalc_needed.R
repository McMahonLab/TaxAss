...
# ---- Define File Paths ----
file.path.blast.table <- "~/Desktop/TaxAss-BatchFiles-go/Mendota/Quickie-TaxAss-Mendota/otus.custom.blast.table.modified" # blast table w/ calculations generated by step 4
file.path.taxa.table <- "~/Desktop/TaxAss-BatchFiles-go/Mendota/Quickie-TaxAss-Mendota/otus.98.80.80.taxonomy" # final taxonomy table generated by step 15
file.path.FW_only.taxa.table <- "~/Desktop/TaxAss-BatchFiles-go/Mendota/Quickie-TaxAss-Mendota/otus.custom.80.taxonomy" # taxonomy table of classifications using custom database only generated in step 15.5.b          
file.path.seqid.reads <- "~/Desktop/TaxAss-BatchFiles-go/Mendota/Quickie-TaxAss-Mendota/total.reads.per.seqID.csv" # table generated by step 14, or by sep call in step 15.5.a
