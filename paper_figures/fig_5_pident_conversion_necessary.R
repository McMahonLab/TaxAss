...
file.path.blast.table <- "~/Desktop/TaxonomyTrainingSets/BLASTing/poster_mend_unclust/otus.custom.blast.table.modified" # blast table w/ calculations generated by step 4
file.path.taxa.table <- "~/Desktop/TaxonomyTrainingSets/BLASTing/poster_mend_unclust/otus.98.70.70.taxonomy" # final taxonomy table generated by step 15
file.path.FW_only.taxa.table <- "~/Desktop/TaxonomyTrainingSets/BLASTing/poster_mend_unclust/otus.custom.70.taxonomy" # taxonomy table of classifications using custom database only generated in step 15.5.b          
file.path.seqid.reads <- "~/Desktop/TaxonomyTrainingSets/BLASTing/poster_mend_unclust/total.reads.per.seqID.csv" # table generated by step 14
